...
?>
    ...
    <?php if($contact_head_title !=''){ ?>
        ...
        <?php if($contacting_us_content !='' || $contact_us_form_shortcode !=''){ ?>
            <div class="row">
                <div class="col-lg-8">
                    <?php if($contacting_us_content !=''){ echo $contacting_us_content; } ?>
                    <?php if($contact_us_form_shortcode !=''){ echo do_shortcode($contact_us_form_shortcode); } ?>
                </div>
      <?php } if($company_info_repeater !=''){ ?>
                <div class="col-lg-4">
                 ...
                 <?php if($company_info_repeater_val['_info_title'] !=''){ ?>
                            ...
                            <?php } if($company_info_repeater_val['_info_content'] !=''){ echo $company_info_repeater_val['_info_content']; } ?>
                        </li>
                    <?php } ?>
                    </ul>
                </div>
