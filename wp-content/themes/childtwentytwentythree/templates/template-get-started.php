            ...
            <div class='row'>
                ...
                <div class="col-lg-6 action-link">
                    <div class="action-link-content">
                        ...
                        <a href="<?php echo $start_page_repeater_val['_start_repeater_button']['url']; ?>"
                            class="cta"><?php echo $start_page_repeater_val['_start_repeater_button']['title']; ?></a>
                        <?php } ?>
                    </div>
                </div>
                <?php } ?>
        ...
        <section class="banner mid-banner mt-5">
            <div class="banner-wrapper ">
                <div class="banner-content">
                    ...
                    <a href="<?php echo $start_bottom_button['url']; ?>"
                        class="cta"><?php echo $start_bottom_button['title']; ?></a>
                    <?php } ?>
                </div>
            </div>
        </section>
