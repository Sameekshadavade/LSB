    ...
    <div class="container-fluid no-padding">
        <section class="row auctions-partner-section">
            ...
            <div class="col-md-6 col-lg">
                ...
                <a href="<?php echo $current_auctions_val['_auctions_link']; ?>" rel="noopener noreferrer"
                    target="_blank">
                    <span>
                        <img src="<?php echo $current_auctions_val['_auctions_image']['url']; ?>"
                            alt="<?php echo $current_auctions_val['_auctions_title']; ?>">
                    </span>
                    <h5><?php echo $current_auctions_val['_auctions_title']; ?></h5>
                    <span class="new-tab-warning">
                        Opens a new window
                        <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/icon_external_link.svg"
                            alt="link_icon">
                    </span>
                </a>
                <?php } ?>
    ...
    <section class="inner-content-section">
        <div class="container page-content">
            ...
            <section class="about-buy-sell row"
                style="background-image: url(<?php echo $welcome_left_desktop_image['url']; ?>);">
                ...
                <div class="col-sm-6 col-lg-3 <?php if($counter == 1){ echo "offset-lg-6"; } ?> ">
                    ...
                    <a href="<?php echo $welcome_repeater_val['_our_auctions_button']['url']; ?>"
                        class="cta"><?php echo $welcome_repeater_val['_our_auctions_button']['title']; ?></a>
                    <?php } ?>
                </div>
                <?php $counter++; }  //if($welcome_left_image[''] !=''){ ?>
                <img class="d-sm-none" src="<?php echo $welcome_left_image['url']; ?>"
                    alt="<?php echo $welcome_left_image['alt']; ?>">
                <?php //} ?>
            </section>
                        ...
                        <a href="#" class="card-body">
                            ...
                            <footer class="entry-footer">
                                <div class="entry-meta">
                                    <span class="posted-on">Posted on <span><time class="entry-date published updated"
