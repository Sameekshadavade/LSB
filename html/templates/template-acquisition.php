            ...
            <div class="col-md-8 offset-md-2 mb-0">
                <div class="summary-opening">
                    <p>
                        ...
                        painless for you. We take care of all the work, details and legal compliance; all you need to do
                        is
                        bring the guns to us or <a href="">schedule an appointment</a> for us to come to you.
                    </p>
                </div>
            </div>
        </section>
        ...
        <section class="row">
            <div class="col mt-4">
                ...
                <div class="summary-opening col-md-8 offset-md-2 mb-0">
                    ...
                    <a href="" class="cta">Download Checklist</a>
                </div>
            </div>
        </section>
        <section class="shipment-details mt-5">
            <div class='row'>
                ...
                <div class="col-md-6 order-md-last mt-5">
                    <figure>
                        <img src="assets/images/colt-model-1905_537x335.jpg" alt="Colt Model 1905">
                ...
                <div class="col-md-6 mt-5">
                    <ul>
                        ...
                        <li>
                            ...
                            <p>
                                It's VERY helpful (and ultimately more valuable) if you have matched your gun with all
                                of
            ...
            <div class="row">
                <div class="col">
                    <div class="banner-cta">
                        <div>
                            <a href="" class="cta">Get Started Here!</a>
                        </div>
                    </div>
                </div>
            </div>
